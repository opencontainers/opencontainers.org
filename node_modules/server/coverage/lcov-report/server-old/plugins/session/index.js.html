...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">server-old/plugins/session</a> index.js
    </h1>
    <div class='clearfix'>
...
<a name='L48'></a><a href='#L48'>48</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">26x</span>
...
<span class="cstat-no" title="statement not covered" >      ctx.options.session.store = new RedisStore({ url: ctx.options.session.redis });</span>
    }
